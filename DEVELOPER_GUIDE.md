...
```bash
git clone https://github.com/awesome-panel/transformers-agent-ui.git
cd transformers-agent-ui
pip install pip -U
...
Update the version in the [__init__.py](src/transformers_agent_ui/__init__.py).
